// A. SVG & Basic D3 Set-up 
// ---------------------------------------------------------
  // dimentions of the browser window.
let svgWidth = 1080;
let svgHeight = 720;
...
// D. Update Functions, Transitions & Tooltips
// ---------------------------------------------------------
      ...
      .on('click', function() {
        ...
        if (value != chosenXAxis) {
          ...
          if (chosenXAxis === 'poverty') {
            ...
            circlesGroup.attr('r', 12).attr('opacity', '.35');
          }
          else if (chosenXAxis === 'age') {
            povertyLabel.classed('active', false).classed('inactive', true);
            ageLabel.classed('active', true).classed('inactive', false);
            incomeLabel.classed('active', false).classed('inactive', true);
            circlesGroup.attr('r', 14).attr('opacity', '.50');
          }
          else {
            povertyLabel.classed('active', false).classed('inactive', true);
            ageLabel.classed('active', false).classed('inactive', true);
            incomeLabel.classed('active', true).classed('inactive', false);
            circlesGroup.attr('r', 16).attr('opacity', '.65');
          }
        }
      });
      ...
      .on('click', function() {
        ...
        if(value !=chosenYAxis) {
            ...
            if (chosenYAxis === 'obesity') {
              ...
              circlesGroup.style('fill','blue');
            }
            else if (chosenYAxis === 'smokes') {
              obesityLabel.classed('active', false).classed('inactive', true);
              smokesLabel.classed('active', true).classed('inactive', false);
              healthcareLabel.classed('active', false).classed('inactive', true);
              circlesGroup.style('fill','red');
            }
            else {
              obesityLabel.classed('active', false).classed('inactive', true);
              smokesLabel.classed('active', false).classed('inactive', true);
              healthcareLabel.classed('active', true).classed('inactive', false);
              circlesGroup.style('fill','green');
            }
          }
        });
});